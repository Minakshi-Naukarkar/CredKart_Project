...
class log_generator_class: # created the class to generate and return logger objects
    ...
    def log_gen_method():# method and will return logger
        ...
        log_format = logging.Formatter("%(asctime)s - %(funcName)s - %(levelname)s - %(lineno)d - %(message)s")# log format
