...
class Test_User_Profile :
    ...
    def test_Credkart_login_002(self):
        ...
        if self.lp.verify_menu_button_visibility() == "pass":
            ...
            allure.attach.file(f".\\Screenshots\\User Login Successful_{self.email}",attachment_type=allure.attachment_type.PNG)
            ...
            allure.attach.file(f".\\Screenshots\\User Login Fail_{self.email}.png",attachment_type=allure.attachment_type.PNG)
    ...
    def test_Credkart_registration_003(self):
        ...
        if self.rp.verify_menu_button_visibility() == "pass":
            ...
            allure.attach.file(f".\\Screenshots\\User Registration Successful_{fake_username}.png",attachment_type=allure.attachment_type.PNG)
            self.log.info(f"Clicking on menu button")
            ...
            allure.attach.file(f".\\Screenshots\\User Registration Fail_{fake_username}.png",attachment_type=allure.attachment_type.PNG)
...
# pytest -n=auto --alluredir=AllureReports --browser headless
